...
def test_initialization_with_defaults(mock_cellpose_model):
...
@patch('src.inference.cellpose_predictor.models.CellposeModel')
def test_initialization_with_custom_params(mock_cellpose_model):
...
@patch('src.inference.cellpose_predictor.models.CellposeModel')
def test_load_model_default(mock_cellpose_model):
...
@patch('src.inference.cellpose_predictor.models.CellposeModel')
def test_load_custom_model(mock_cellpose_model):
...
@patch('src.inference.cellpose_predictor.models.CellposeModel')
def test_load_model_failure(mock_cellpose_model):
...
@patch('src.inference.cellpose_predictor.models.CellposeModel')
def test_predict_single_image(mock_cellpose_model):
...
@patch('src.inference.cellpose_predictor.models.CellposeModel')
def test_predict_with_custom_params(mock_cellpose_model):
...
@patch('src.inference.cellpose_predictor.models.CellposeModel')
def test_predict_z_stack_2d(mock_cellpose_model):
...
@patch('src.inference.cellpose_predictor.models.CellposeModel')
def test_get_model_info(mock_cellpose_model):
...
@patch('src.inference.cellpose_predictor.models.CellposeModel')
def test_channels_parameter_handling(mock_cellpose_model):
...
@patch('src.inference.cellpose_predictor.models.CellposeModel')
def test_gpu_detection(mock_cellpose_model):
...
@patch('src.inference.cellpose_predictor.models.CellposeModel')
def test_predict_empty_image(mock_cellpose_model):
...
@patch('src.inference.cellpose_predictor.models.CellposeModel')
def test_error_handling_in_predict(mock_cellpose_model):
