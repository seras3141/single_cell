"""Napari visualization widgets for the cell activity labeler.
...
from cell_activity_labeler.config import ThresholdConfig

if TYPE_CHECKING:
    import napari.layers
from cell_activity_labeler.core import ThresholdClassifier
...
def threshold_classifier_widget(
    ...
    from cell_activity_labeler.config import ThresholdConfig, ThresholdParams, PreprocessingConfig
    from cell_activity_labeler.core import ThresholdClassifier
